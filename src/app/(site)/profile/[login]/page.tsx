                    ...
                    <div className="grid auto-cols-[70px] grid-cols-[1fr,auto,1fr] items-center gap-3">
                        <div>
                            <div className="grid w-full items-center gap-3 grid-cols-[1fr,auto]">
                                ...
                                <p className="min-w-[1px] truncate text-small font-medium leading-[20px] tracking-gg-wider text-gg-light-3 order-1 text-right"><Link href={`http://${location.host}/profile/${game.player1login}`}>{game.player1login}</Link> </p>
                            </div>
                           </div>
                        ...
                        <div>
                            <div className="grid w-full items-center gap-3 grid-cols-[auto,1fr]">
                                ...
                                <p className="min-w-[1px] truncate text-small font-medium leading-[20px] order-1 text-left">
                                    <Link href={`http://${location.host}}/profile/${game.player2login}`}>{game.player2login}</Link> 
                                </p>
                            </div>
                           </div>
                    </div>
